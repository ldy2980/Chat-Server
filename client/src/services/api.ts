...
export const userApi = {
  ...
  getSettings: async (userId: number): Promise<UserSettings> => {
    const response: AxiosResponse<UserSettings> = await api.get(
  ...
  updateSettings: async (
    ...
    const response: AxiosResponse<UserSettings> = await api.put(
      `/users/${userId}/settings`,
      settings,
    );
    return response.data;
...
export const chatRoomApi = {
  ...
  update: async (
    ...
    const response: AxiosResponse<ChatRoom> = await api.put(
      `/chat-rooms/${chatRoomId}`,
      data,
    );
    return response.data;
...
export const messageApi = {
  ...
  markAsRead: async (
    ...
    await api.post(`/chat-rooms/${chatRoomId}/messages/${messageId}/read`, {
      userId,
    });
  },
};
